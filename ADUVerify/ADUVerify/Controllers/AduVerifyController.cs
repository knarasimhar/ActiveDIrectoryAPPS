...
{ 
    ...
    public class AduVerifyController : ApiController
    {
        ...
        public void loadDefaultValues()
        {
            ...
            {
                new SelectListItem { Text = "National", Value = "OU=National,OU=PIP,DC=saathispdt,DC=com" },
                new SelectListItem { Text = "States", Value = "OU=State,OU=PIP,DC=saathispdt,DC=com" }
